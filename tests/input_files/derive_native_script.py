...
ValidNativeScriptTestCases = [
    ...
    ValidNativeScriptTestCase(
        "PUBKEY - third party (script hash displayed as policy id)",
        NativeScript(
            NativeScriptType.PUBKEY_THIRD_PARTY,
            NativeScriptParamsPubkey(
                "3a55d9f68255dfbefa1efd711f82d005fae1be2e145d616c90cf0fa9"
    ...
    ValidNativeScriptTestCase(
        "INVALID_BEFORE script (slot is a big number)",
        NativeScript(
    ...
    ValidNativeScriptTestCase(
        "INVALID_HEREAFTER script (slot is a big number)",
        NativeScript(
