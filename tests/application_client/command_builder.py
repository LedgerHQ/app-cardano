...
from input_files.derive_native_script import (
    NativeScript,
    NativeScriptType,
...
class CommandBuilder:
    ...
    def _serialize(
        self, ins: InsType, p1: int = 0x00, p2: int = 0x00, cdata: bytes = bytes()
    ) -> bytes:
    ...
    def sign_cip36_init(self, testCase: CVoteTestCase) -> bytes:
        ...
        chunk_size = min(
            MAX_CIP36_PAYLOAD_SIZE * 2, len(testCase.cVote.voteCastDataHex)
        )
    ...
    def sign_msg_chunk(self, testCase: SignMsgTestCase) -> List[bytes]:
        ...
        while True:
            ...
            chunks.append(
                self._serialize(InsType.SIGN_MSG, P1Type.P1_CHUNK, 0x00, data)
            )
    ...
    def sign_tx_init(self, testCase: SignTxTestCase, nbWitnessPaths: int) -> bytes:
        ...
        data += self._serializeOptionFlags(
            testCase.tx.validityIntervalStart is not None
        )
    ...
    def sign_tx_aux_data_init(self, auxData: TxAuxiliaryDataCIP36) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_AUX_DATA, P2Type.P2_INIT, data
        )
    ...
    def sign_tx_aux_data_vote_key(self, auxData: TxAuxiliaryDataCIP36) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_AUX_DATA, P2Type.P2_VOTE_KEY, data
        )
    ...
    def sign_tx_aux_data_delegation(self, delegation: CIP36VoteDelegation) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_AUX_DATA, P2Type.P2_DELEGATION, data
        )
    ...
    def sign_tx_aux_data_staking(self, auxData: TxAuxiliaryDataCIP36) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_AUX_DATA, P2Type.P2_STAKING_KEY, data
        )
    ...
    def sign_tx_aux_data_payment(self, auxData: TxAuxiliaryDataCIP36) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_AUX_DATA, P2Type.P2_PAYMENT_ADDRESS, data
        )
    ...
    def sign_tx_aux_data_nonce(self, auxData: TxAuxiliaryDataCIP36) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_AUX_DATA, P2Type.P2_NONCE, data
        )
    ...
    def sign_tx_aux_data_voting_purpose(self, auxData: TxAuxiliaryDataCIP36) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_AUX_DATA, P2Type.P2_VOTING_PURPOSE, data
        )
    ...
    def sign_tx_aux_data_confirm(self) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_AUX_DATA, P2Type.P2_AUX_CONFIRM
        )
    ...
    def sign_tx_outputs_basic(self, txOutput: TxOutput) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_OUTPUTS, P2Type.P2_BASIC_DATA, data
        )
    ...
    def sign_tx_outputs_datum(self, datum: Datum) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_OUTPUTS, P2Type.P2_DATUM, data
        )
    ...
    def sign_tx_outputs_ref_script(self, referenceScriptHex: str) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_OUTPUTS, P2Type.P2_SCRIPT, data
        )
    ...
    def sign_tx_validity(self, validity: int) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_VALIDITY_INTERVAL_START, 0x00, data
        )
    ...
    def sign_tx_mint_init(self, nbMints: int) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_MINT, P2Type.P2_BASIC_DATA, data
        )
    ...
    def sign_tx_collateral_output_basic(self, txOutput: TxOutput) -> bytes:
        ...
        if isinstance(txOutput, TxOutputBabbage):
            ...
            data += self._serializeOptionFlags(False)
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_COLLATERAL_OUTPUT, P2Type.P2_BASIC_DATA, data
        )
    ...
    def sign_tx_collateral_output_confirm(self) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_COLLATERAL_OUTPUT, P2Type.P2_CONFIRM
        )
    ...
    def sign_tx_cert_pool_reg_init(self, pool: PoolRegistrationParams) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_CERT_INIT, data
        )
    ...
    def sign_tx_cert_pool_reg_pool_key(self, pool: PoolKey) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_POOL_KEY, data
        )
    ...
    def sign_tx_cert_pool_reg_vrf(self, pool: str) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_VRF_KEY, data
        )
    ...
    def sign_tx_cert_pool_reg_financials(self, pool: PoolRegistrationParams) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_FINANCIALS, data
        )
    ...
    def sign_tx_cert_pool_reg_reward(self, pool: PoolKey) -> bytes:
        ...
        if pool.key.startswith("m/"):
            ...
            data += bytes.fromhex(pool.key)
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_REWARD_ACCOUNT, data
        )
    ...
    def sign_tx_cert_pool_reg_owner(self, pool: PoolKey) -> bytes:
        ...
        if pool.key.startswith("m/"):
            ...
            data += bytes.fromhex(pool.key)
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_OWNERS, data
        )
    ...
    def sign_tx_cert_pool_reg_relay(self, pool: Relay) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_RELAYS, data
        )
    ...
    def sign_tx_cert_pool_reg_metadata(self, pool: PoolMetadataParams) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_METADATA, data
        )
    ...
    def sign_tx_cert_pool_reg_confirm(self) -> bytes:
        ...
        return self._serialize(
            InsType.SIGN_TX, P1Type.P1_CERTIFICATES, P2Type.P2_CERT_CONFIRM
        )
    ...
    def derive_script_add_simple(self, script: NativeScript) -> bytes:
        ...
        return self._serialize(
            InsType.DERIVE_SCRIPT_HASH, P1Type.P1_ADD_SIMPLE_SCRIPT, 0x00, data
        )
    ...
    def derive_script_add_complex(self, script: NativeScript) -> bytes:
        ...
        return self._serialize(
            InsType.DERIVE_SCRIPT_HASH, P1Type.P1_COMPLEX_SCRIPT_START, 0x00, data
        )
    ...
    def derive_script_finish(self, disp: NativeScriptHashDisplayFormat) -> bytes:
        ...
        return self._serialize(
            InsType.DERIVE_SCRIPT_HASH, P1Type.P1_WHOLE_NATIVE_SCRIPT_FINISH, 0x00, data
        )
